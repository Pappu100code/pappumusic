class Connection {
    ...
    updatePlayerVoiceData() {
        this.player.pappumusic.emit("debug", this.player.node.name,`[Rest Manager] Sending an Update Player request with data: ${JSON.stringify({ voice: this.voice})}`)
