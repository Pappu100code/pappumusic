...
class pappumusic extends EventEmitter {
    constructor(client, nodes, options) {
        super();
        if (!client) throw new Error("Client is required to initialize pappumusic");
        if (!nodes) throw new Error("Nodes are required to initialize pappumusic");
        if (!options.send) throw new Error("Send function is required to initialize pappumusic");
    ...
    createConnection(options) {
        if (!this.initiated) throw new Error("You have to initialize pappumusic in your ready event");
